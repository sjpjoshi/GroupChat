...
public class User extends JFrame implements ActionListener, Runnable {
	 ...
	 User() {
	    ...
	    //Image icon = new ImageIcon(this.getClass().getResource("C:\\Users\\suraj\\OneDrive\\Desktop\\Group-Chat-main\\GroupChat\\src")).getImage().getScaledInstance(30, 30, Image.SCALE_DEFAULT);
